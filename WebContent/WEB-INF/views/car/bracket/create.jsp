...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">录入托架信息</h3>
	</div>
	<div class="panel-body">
		<div class="row">
			<div class="col-md-11">
				<form id="bracket-form" class="form-horizontal">
					<!-- 托架编号，托架牌，车架名称，购买时间，备注 -->
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text"
								...
								class="form-control span2" id="buyDate" name="buyDate" size="10"
								placeholder="xxxx-xx-xx" required>
						</div>
						<label for="price" class="col-sm-2 control-label">价格</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="price" id="price"
								pattern="^[1-9]\d*|0$" maxlength="8"
